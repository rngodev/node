...
export type NodePollConfigFilePublicationQuery = { __typename?: 'Query', configFilePublication?: { __typename?: 'ConfigFilePublication', result?: { __typename: 'ConfigFile', key: string, branch?: { __typename?: 'Branch', name: string } | null } | { __typename: 'Failure', issues: Array<{ __typename: 'ConcurrencyIssue', message: string, path?: string | null } | { __typename: 'ExpressionIssue', message: string, path?: string | null } | { __typename: 'GenericIssue', message: string, path?: string | null } | { __typename: 'PreviewVolumeIssue', message: string, path?: string | null } | { __typename: 'RngoCapacityIssue', message: string, path?: string | null }> } | null } | null };
...
export type NodePollSimulationCompilationQuery = { __typename?: 'Query', simulationCompilation?: { __typename?: 'SimulationCompilation', result?: { __typename: 'Failure', issues: Array<{ __typename: 'ConcurrencyIssue', message: string, path?: string | null } | { __typename: 'ExpressionIssue', message: string, path?: string | null } | { __typename: 'GenericIssue', message: string, path?: string | null } | { __typename: 'PreviewVolumeIssue', message: string, path?: string | null } | { __typename: 'RngoCapacityIssue', message: string, path?: string | null }> } | { __typename: 'Simulation', id: string } | null } | null };
...
export type NodeRunSimulationToFileMutation = { __typename?: 'Mutation', runSimulationToFile: { __typename: 'Failure', issues: Array<{ __typename: 'ConcurrencyIssue', message: string, path?: string | null } | { __typename: 'ExpressionIssue', message: string, path?: string | null } | { __typename: 'GenericIssue', message: string, path?: string | null } | { __typename: 'PreviewVolumeIssue', availableUnits: number, requiredUnits: number, message: string, path?: string | null } | { __typename: 'RngoCapacityIssue', message: string, path?: string | null }> } | { __typename: 'FileSink', id: string } };
...
export type NodePollSimulationSinksQuery = { __typename?: 'Query', simulation?: { __typename?: 'Simulation', id: string, sinks: Array<{ __typename?: 'FileSink', id: string, importScriptUrl?: string | null, metadataUrl?: string | null, completedAt?: any | null, archives: Array<{ __typename?: 'Archive', url: string }> }> } | null };

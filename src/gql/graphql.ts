...
export type InsufficientPreviewVolumeError = Error & {
  ...
  availableBytes: Scalars['Int']['output'];
  message: Scalars['String']['output'];
  requiredBytes: Scalars['Int']['output'];
};

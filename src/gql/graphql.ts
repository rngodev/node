...
export type UpsertConfigFileMutation = { __typename?: 'Mutation', upsertConfigFile: { __typename: 'ConfigFile', id: string, branch?: { __typename?: 'Branch', name: string } | null } | { __typename: 'SynchronizationError', message: string } | { __typename: 'UpsertConfigFileFailure', config?: Array<never> | null } };

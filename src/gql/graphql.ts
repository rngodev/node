...
export type DrainSimulationToFileResult = CapacityError | DrainSimulationToFileValidationError | FileSink | InsufficientPreviewCreditsError | SynchronizationError;
...
export type InsufficientPreviewCreditsError = Error & {
  __typename?: 'InsufficientPreviewCreditsError';
...
export type CreateSimulationMutation = { __typename?: 'Mutation', createSimulation: { __typename: 'CreateSimulationFailure', branchId?: Array<{ __typename?: 'CapacityError', message: string } | { __typename?: 'InsufficientPreviewCreditsError', message: string } | { __typename?: 'SynchronizationError', message: string }> | null } | { __typename: 'Simulation', id: string } };
...
export type DrainSimulationToFileMutation = { __typename?: 'Mutation', drainSimulationToFile: { __typename: 'CapacityError', message: string } | { __typename: 'DrainSimulationToFileValidationError', simulationId?: Array<{ __typename?: 'CapacityError', message: string } | { __typename?: 'InsufficientPreviewCreditsError', message: string } | { __typename?: 'SynchronizationError', message: string }> | null } | { __typename: 'FileSink', id: string, importScriptUrl?: string | null, archives: Array<{ __typename?: 'Archive', url: string }> } | { __typename: 'InsufficientPreviewCreditsError', message: string, available: number, required: number } | { __typename: 'SynchronizationError', message: string } };
